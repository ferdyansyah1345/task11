...
class MahasantriController extends Controller
{
    ...
    public function show(string $id)
    {
        ...
        ->join('dosen', 'mahasantri.dosen_id', '=', 'mahasantri.dosen_id')
        ->join('jurusan', 'mahasantri.jurusan_id', '=', 'mahasantri.jurusan_id')
        ->join('matakuliah', 'dosen.matakuliah_id', '=', 'dosen.matakuliah_id')
